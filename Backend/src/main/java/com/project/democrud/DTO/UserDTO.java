...
public class UserDTO {
    ...
    public UserDTO(int id_user,String immatriculation, String nom, String prenom, String cin, String email, int mobile,ERole role,Date date_de_naissance,String lieu_de_naissance,String mot_de_pass,int age) {
